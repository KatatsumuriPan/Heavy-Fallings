...
public abstract class AbstractConfigProperty implements IConfigElement {
	...
	protected AbstractConfigProperty(String id, String commentForFile, int order, ConfigSide side) {
		this.id = id;
	...
	public static abstract class AbstractConfigPropertyList extends AbstractConfigProperty {
		...
		protected AbstractConfigPropertyList(String id, String commentForFile, int order, ConfigSide side) {

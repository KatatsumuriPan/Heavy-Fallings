...
import kpan.heavy_fallings.config.core.gui.ModGuiConfigEntries.IntegerEntry;
...
public class ConfigPropertyInt extends AbstractConfigProperty {
	...
	public ConfigPropertyInt(String id, int defaultValue, int minValue, int maxValue, String commentForFile, int order, ConfigSide side) {
